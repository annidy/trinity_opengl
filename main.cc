...
int main() {
    ...
    unsigned char *data = stbi_load("assets/timg.jpeg", &width, &height, &nrChannels, 0);
...
//    unsigned char *prop_data = stbi_load("assets/effect/roseEyeMakeup/FaceMakeupV2_2999/mask2999/mask2999_000.png", &width, &height, &nrChannels, STBI_rgb_alpha);
//    printf("width = %d height = %d\n", width, height);
//
...
//    background.SetImage("/Users/wlanjie/project/trinity/assets/lenna.png", 512, 512);
...
//    texture_id = frame_buffer.OnDrawFrame(texture_id, DEFAULT_VERTEX_COORDINATE, DEFAULT_TEXTURE_COORDINATE);
    ...
    char* name = "assets/effect/spaceBear";
...
//        int process_id = face_point.OnDrawFrame(texture_id, prop_texture_id);
       ...
       image_process.OnUpdateEffectParam(0, "spaceBear", "stickerRotate", (float)glfwGetTime() * 10);
        ...
        int texture = background.OnDrawFrame(process_id, 1080, 1080, VERTEX_COORDINATE);
